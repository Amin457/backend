const {createFeed,getAllQuest,insertQuestion,insertReponse,getReponse,getFeed,deleteQuestion,getAllReponse} = require("./feedback.controller");
...
router.get("/getAllReponse",getAllReponse)
